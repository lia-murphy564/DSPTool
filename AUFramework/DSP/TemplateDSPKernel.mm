...
#import "TemplateDSPKernel.hpp"
#import "TemplateDSPKernelAdapter.h"

@implementation TemplateDSPKernelAdapter {
    // C++ members need tos be ivars; they would be copied on access if they were properties.
    TemplateDSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block TemplateDSPKernel *state = &_kernel;
