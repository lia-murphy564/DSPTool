//
//  GainStageAudioUnit.m
//  GainStage
//
//  Created by Amelia Murphy on 6/21/22.
//

#import "GainStageAudioUnit.h"
...
@implementation GainStageAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[GainStageDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block GainStageDSPKernelAdapter * kernelAdapter = _kernelAdapter;
